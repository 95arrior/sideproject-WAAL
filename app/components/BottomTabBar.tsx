    ...
    icon: (active) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path
          ...
          stroke={active ? "#3f59ff" : "#b4b4b4"}
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
          fill={active ? "rgba(63,89,255,0.1)" : "none"}
        />
      </svg>
    ),
  },
...
export default function BottomTabBar() {
  ...
  const getActiveTab = (): Tab => {
    if (pathname === "/parent/explore" || pathname.startsWith("/parent/explore/")) return "explore";
    if (pathname === "/parent/setting") return "setting";
    return "home";
  };
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center">
      <div className="w-full max-w-[720px] bg-white border-t border-[#f0f0f0] px-4 pb-safe">
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className="flex flex-col items-center gap-[4px] flex-1 py-2 transition-opacity active:opacity-70"
              >
                {tab.icon(isActive)}
                <span
                  className={`text-[11px] font-semibold ${
                    isActive ? "text-[#3f59ff]" : "text-[#b4b4b4]"
                  }`}
                >
                  {tab.label}
                </span>
